...
Route::group(['prefix'=>'Contacts'],function (){
    ...
    Route::any('/store', [\App\Http\Controllers\TableController::class , "store"]);
    Route::get('/contacts', [\App\Http\Controllers\TableController::class , "index"]);
    Route::get('/delete/{id}', [\App\Http\Controllers\TableController::class , "destroy"]);
    Route::get('/edit/{id}', [\App\Http\Controllers\TableController::class , "edit"]);
    Route::any('/update/{id}', [\App\Http\Controllers\TableController::class , "update"]);
    Route::get('/show', [\App\Http\Controllers\TableController::class , "show"]);
    Route::get('/page/{page}', [\App\Http\Controllers\TableController::class , "paginate"]);
    Route::get('/user/{id}', [\App\Http\Controllers\TableController::class , "user"]);

});

Route::group(['prefix'=>'users'],function (){

    Route::any('/store', [\App\Http\Controllers\UserController::class , "store"]);
    Route::get('/index/{page}', [\App\Http\Controllers\UserController::class , "index"]);
    ...
    Route::get('/page/{page}', [\App\Http\Controllers\UserController::class , "paginate"]);
    Route::get('/history/{page}/{id}', [\App\Http\Controllers\UserController::class , "search_history"]);
    Route::get('/callLogs/{page}/{id}', [\App\Http\Controllers\UserController::class , "callLogs_search"]);
    Route::get('/complains/{page}/{id}', [\App\Http\Controllers\UserController::class , "complains_search"]);
    Route::get('/contacts/{page}/{id}', [\App\Http\Controllers\UserController::class , "contacts_search"]);
    Route::get('/edit_history/{id}', [\App\Http\Controllers\UserController::class , "edit_history"]);
    Route::any('/update_history/{id}', [\App\Http\Controllers\UserController::class , "update_history"]);
    Route::get('/edit_callLogs/{id}', [\App\Http\Controllers\UserController::class , "edit_callLogs"]);
    Route::any('/update_callLogs/{id}', [\App\Http\Controllers\UserController::class , "update_callLogs"]);
    Route::get('/edit_contacts/{id}', [\App\Http\Controllers\UserController::class , "edit_contacts"]);
    Route::any('/update_contacts/{id}', [\App\Http\Controllers\UserController::class , "update_contacts"]);
    Route::get('/delete_history/{id}', [\App\Http\Controllers\UserController::class , "destroy_history"]);
    Route::get('/delete_callLogs/{id}', [\App\Http\Controllers\UserController::class , "destroy_callLogs"]);
    Route::get('/delete_contacts/{id}', [\App\Http\Controllers\UserController::class , "destroy_contacts"]);

});

Route::group(['prefix'=>'complaints'],function (){

    Route::any('/store', [\App\Http\Controllers\complaints_controller::class , "store"]);
    Route::get('/index', [\App\Http\Controllers\complaints_controller::class , "index"]);
    Route::get('/page', [\App\Http\Controllers\complaints_controller::class , "page"]);
    Route::get('/table/{page}', [\App\Http\Controllers\complaints_controller::class , "table"]);
    Route::get('/create', [\App\Http\Controllers\complaints_controller::class , "create"]);
    Route::get('/delete/{id}', [\App\Http\Controllers\complaints_controller::class , "destroy"]);
    Route::get('/edit/{id}', [\App\Http\Controllers\complaints_controller::class , "edit"]);
    Route::any('/update/{id}', [\App\Http\Controllers\complaints_controller::class , "update"])->name("ajax.update");
    Route::get('/edit/{id}', [\App\Http\Controllers\complaints_controller::class , "edit"]);
    Route::get('/profile/{id}', [\App\Http\Controllers\complaints_controller::class , "profile"]);
    Route::get('/history/{page}/{id}', [\App\Http\Controllers\complaints_controller::class , "search_history"]);

});

Route::group(['prefix'=>'socials'],function (){

    Route::get('/index', [\App\Http\Controllers\SocialsController::class , "index"]);
    Route::get('/facebook/{page}', [\App\Http\Controllers\SocialsController::class , "facebook"]);
    Route::get('/whatsapp/{page}', [\App\Http\Controllers\SocialsController::class , "whatsapp"]);
    Route::get('/twitter/{page}', [\App\Http\Controllers\SocialsController::class , "twitter"]);
    Route::get('/snapchat/{page}', [\App\Http\Controllers\SocialsController::class , "snapchat"]);
    Route::any('/store', [\App\Http\Controllers\SocialsController::class , "store"]);
    Route::get('/delete/{id}', [\App\Http\Controllers\SocialsController::class , "destroy"]);
    Route::get('/edit/{id}', [\App\Http\Controllers\SocialsController::class , "edit"]);
    Route::any('/update/{id}', [\App\Http\Controllers\SocialsController::class , "update"]);
    Route::get('/show', [\App\Http\Controllers\SocialsController::class , "show"]);
});

Route::group(['prefix'=>'about'],function (){

    Route::get('/index', [\App\Http\Controllers\AboutUsController::class , "index"]);
    Route::get('/edit/{id}', [\App\Http\Controllers\AboutUsController::class , "edit"]);
    Route::any('/save', [\App\Http\Controllers\AboutUsController::class , "save"]);

});


Route::group(['prefix'=>'CallLogs'],function (){

    Route::any('/store', [\App\Http\Controllers\CallLogsController::class , "store"]);
    Route::get('/index/{page}', [\App\Http\Controllers\CallLogsController::class , "index"]);
    Route::get('/page', [\App\Http\Controllers\CallLogsController::class , "page"]);
    Route::get('/delete/{id}', [\App\Http\Controllers\CallLogsController::class , "destroy"]);
    Route::get('/edit/{id}', [\App\Http\Controllers\CallLogsController::class , "edit"]);
    Route::any('/update/{id}', [\App\Http\Controllers\CallLogsController::class , "update"]);
    Route::get('/show', [\App\Http\Controllers\CallLogsController::class , "show"]);
    Route::get('/page/{page}', [\App\Http\Controllers\CallLogsController::class , "paginate"]);
    Route::get('/history/{page}/{id}', [\App\Http\Controllers\CallLogsController::class , "search_history"]);
