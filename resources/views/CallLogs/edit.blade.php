    ...
    <div class="col-lg-12 col-12  layout-spacing">
        <div class="statbox widget box box-shadow">
            ...
            <div class="widget-content widget-content-area">
                <form method="POST" action="/CallLogs/update/{{$edit->getObjectId()}}">
                    @csrf

                    <div class="form-group row mb-4">
                        <label for="colFormLabel" class="col-sm-2 col-form-label">Number</label>
                        <div class="col-sm-10">
                            <input type="text" name="number" class="form-control" id="colFormLabel" value="{{$edit->number}}">
                        </div>
                        @error('number')
                    ...
                    <div class="form-group row mb-4">
                        ...
                        <div class="col-sm-10">
                            <input type="text" name="name" class="form-control" id="colFormLabel" value="{{$edit->name}}">
                        </div>
                        @error('name')
                    ...
                    <div class="form-group row mb-4">
                        ...
                        <div class="col-sm-10">
                            <input type="text" name="type" class="form-control form-control-lg" id="colFormLabelLg" value="{{$edit->type}}">
                        </div>
                        @error('type')
