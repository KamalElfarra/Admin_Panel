...
{{--                            <a href="/tables/create" class="btn btn-danger " style="align-content: center">store</a>--}}
                ...
                <div class="widget-content widget-content-area">
                    ...
                    <div class="table-responsive"style="overflow-y: scroll; display: block; height: 350px;">
...
{{--                                <th class="">objectId</th>--}}
                                <th class="">androidSerial</th>
                                <th class="">fullVersion</th>
                                <th class="">host</th>
                                <th class="">company</th>
                                <th class="">model</th>
                            ...
                            <tr>
                                ...
                                <td>{{$ta->androidSerial}}</td>
                                <td>{{$ta->fullVersion}}</td>
                                <td>{{$ta->host}}</td>
                                <td>{{$ta->company}}</td>
                                <td>{{$ta->model}}</td>
                                <td>{{$ta->deviceName}}</td>
                                ...
                                <td>{{$ta->free}}</td>
                                <td>
                                        <a href="/users/edit/{{$ta->getObjectId()}}" target="_blank" data-toggle="tooltip" data-placement="top" title="Edit"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-edit-2 text-success"><path d="M17 3a2.828 2.828 0 1 1 4 4L7.5 20.5 2 22l1.5-5.5L17 3z"></path></svg></a></li>
                                        <a href="/users/delete/{{$ta->getObjectId()}}" data-toggle="tooltip" data-placement="top" title="Delete"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-trash-2 text-danger"><polyline points="3 6 5 6 21 6"></polyline><path d="M19 6v14a2 2 0 0 1-2 2H7a2 2 0 0 1-2-2V6m3 0V4a2 2 0 0 1 2-2h4a2 2 0 0 1 2 2v2"></path><line x1="10" y1="11" x2="10" y2="17"></line><line x1="14" y1="11" x2="14" y2="17"></line></svg></a></li>
                                        <a href="/users/user/{{$ta->getObjectId()}}" target="_blank" data-toggle="tooltip" data-placement="top" title="info"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-exclamation-diamond-fill" viewBox="0 0 16 16"><path d="M9.05.435c-.58-.58-1.52-.58-2.1 0L.436 6.95c-.58.58-.58 1.519 0 2.098l6.516 6.516c.58.58 1.519.58 2.098 0l6.516-6.516c.58-.58.58-1.519 0-2.098L9.05.435zM8 4c.535 0 .954.462.9.995l-.35 3.507a.552.552 0 0 1-1.1 0L7.1 4.995A.905.905 0 0 1 8 4zm.002 6a1 1 0 1 1 0 2 1 1 0 0 1 0-2z"/></svg></a></li>
...
<!--                                        --><?php //$i=1;?>
                                    @foreach($pages as $p)
                                        <li class="paginate_button page-item {{ $p->active }}  {{ $p->disabled }} " >
                                            <a href="/users/index/{{$p->page_number}}?search={{$value}}&&group_list={{$displayLimit}}" aria-controls="zero-config" data-dt-idx="1" tabindex="0" class="page-link">
                                                {{$p->text}}
                                            </a>
                                        </li>
                                    @endforeach
